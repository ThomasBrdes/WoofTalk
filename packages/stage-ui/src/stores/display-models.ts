...
const displayModelsPresets: DisplayModel[] = [
  ...
  { id: 'preset-vrm-1', format: DisplayModelFormat.VRM, type: 'url', url: '/WoofTalk/public/assets/vrm/models/AvatarSample-A/AvatarSample_A.vrm', name: 'Megumi', previewImage: '/WoofTalk/public/assets/vrm/models/AvatarSample-A/preview.png', importedAt: 1733113886840 },
  { id: 'preset-vrm-2', format: DisplayModelFormat.VRM, type: 'url', url: '/WoofTalk/public/assets/vrm/models/AvatarSample-B/AvatarSample_B.vrm', name: 'Baibai', previewImage: '/WoofTalk/public/assets/vrm/models/AvatarSample-B/preview.png', importedAt: 1733113886840 },
  { id: 'preset-vrm-3', format: DisplayModelFormat.VRM, type: 'url', url: '/WoofTalk/public/assets/vrm/models/frieren/frieren.vrm', name: 'Frieren', previewImage: '/WoofTalk/public/assets/vrm/models/frieren/preview.png', importedAt: 1733113886840 },
  { id: 'preset-vrm-8', format: DisplayModelFormat.VRM, type: 'url', url: '/WoofTalk/public/assets/vrm/models/kiroku/kiroku.vrm', name: 'Kiroku', previewImage: '/WoofTalk/public/assets/vrm/models/kiroku/preview.png', importedAt: 1733113886840 },
  { id: 'preset-vrm-9', format: DisplayModelFormat.VRM, type: 'url', url: '/WoofTalk/public/assets/vrm/models/maria/maria.vrm', name: 'Maria', previewImage: '/WoofTalk/public/assets/vrm/models/maria/preview.png', importedAt: 1733113886840 },
  { id: 'preset-vrm-10', format: DisplayModelFormat.VRM, type: 'url', url: '/WoofTalk/public/assets/vrm/models/magna/magna.vrm', name: 'Magna', previewImage: '/WoofTalk/public/assets/vrm/models/magna/preview.png', importedAt: 1733113886840 },
  { id: 'preset-vrm-11', format: DisplayModelFormat.VRM, type: 'url', url: '/WoofTalk/public/assets/vrm/models/moonie/moonie.vrm', name: 'Moonie', previewImage: '/WoofTalk/public/assets/vrm/models/moonie/preview.png', importedAt: 1733113886840 },
]
