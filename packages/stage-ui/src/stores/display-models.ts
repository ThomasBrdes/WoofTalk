...
const displayModelsPresets: DisplayModel[] = [
  ...
  { id: 'preset-vrm-9', format: DisplayModelFormat.VRM, type: 'url', url: '/assets/vrm/models/maria/maria.vrm', name: 'Maria', previewImage: '/assets/vrm/models/maria/preview.png', importedAt: 1733113886840 },
